...
import com.example.arshit.chatapp.AddStoryActivity;
import com.example.arshit.chatapp.Model.Story;
import com.example.arshit.chatapp.Model.User;
import com.example.arshit.chatapp.MyGlideApp;
import com.example.arshit.chatapp.R;
import com.example.arshit.chatapp.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            story_plus = itemView.findViewById(R.id.story_photo_plus);
...
//                Glide.with(mContext).load(user.getProfilePic()).into(viewHolder.story_photo);

                if (pos != 0) {

                    Glide.with(mContext).load(user.getProfilePic()).into(viewHolder.story_photo_seen);
                    ...
                    if (count > 0) {
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "Add Story",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        Intent intent;
                                        intent = new Intent(mContext, AddStoryActivity.class);
                                        mContext.startActivity(intent);
                                        dialog.dismiss();
                                    }
                                });
