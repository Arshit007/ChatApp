...
//                 Picasso.with(SettingsActivity.this).load(image).placeholder(R.drawable.profile_avatar).into(uImg);

                 Picasso.get().load(image).placeholder(R.drawable.profile_avatar).into(uImg);
        }
    ...
    private void inti(){
        ...
        uName = findViewById(R.id.displayname);
        uStatus = findViewById(R.id.status);
        uImg = findViewById(R.id.profileimage);
        btnImg = findViewById(R.id.btn_image);
        btnStaus = findViewById(R.id.btn_staus);
...
//        });
    ...
    private void status() {
        ...
        btnStaus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                String status_value = uStatus.getText().toString();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
             ...
             StorageReference filepath = imgStorageReference.child("Profile_images").child(current_user_id+".jpg");
            ...
            filepath.putFile(resultUri).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                      ...
                      if (task.isSuccessful()){
                          ...
                          imgStorageReference.child("Profile_images").child(current_user_id+".jpg").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                              @Override
                              public void onSuccess(Uri uri) {

                                  String downloadUrl = uri.toString();

                                  databaseReference.child("imageURL").setValue(downloadUrl).addOnCompleteListener(new OnCompleteListener<Void>() {
                                      @Override
